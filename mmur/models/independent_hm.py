...
from mmur.stan import _ind_hm_code

class IndependentHMConfusionMatrix(ConfusionMatrixBase):
    """Model a confusion matrix using a hierarchical model that assumes independent confusion matrices."""
    def __init__(self, random_state=None):
        """Initialise the class."""
        self.code = _ind_hm_code
        self.prior_vars = ['gam_a', 'gam_b','alpha']
        self.post_vars = ['y_hat', 'pi_hat']
